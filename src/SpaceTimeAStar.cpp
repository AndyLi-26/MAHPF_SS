...
Path SpaceTimeAStar::findOptimalPath(const PathTable& path_table, SpaceTimeAStar::Cost obj)
{
    Path path;
    num_expanded = 0;
    num_generated = 0;
...
inline AStarNode* SpaceTimeAStar::popNode(SpaceTimeAStar::Cost obj)
{
    AStarNode* node;
...
inline void SpaceTimeAStar::pushNode(AStarNode* node, SpaceTimeAStar::Cost obj)
{
    if(obj==Cost::CONF)
